...
(function($){
  ...
  Timer.prototype.clearTimer = function(element){
    element.find('.seconds').text('00 Detik');
    element.find('.minutes').text('00 Menit :');
    element.find('.hours').text('00 Jam :');
  };
  ...
  Timer.prototype.setFinalValue = function(finalValues, element) {
    ...
    element.find('.seconds').text(finalValues.pop() + ' Detik');
    element.find('.minutes').text(finalValues.pop() + ' Menit, ');
    element.find('.hours').text(finalValues.pop() + ' Jam, ');
  };
